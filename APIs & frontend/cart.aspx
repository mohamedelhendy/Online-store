<form id="form1" runat="server">
    <asp:GridView runat="server" AutoGenerateColumns="False" DataKeyNames="serial_no" DataSourceID="SqlDataSource1">
        <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=desktop-dvecpbc\sqlexpress01;Initial Catalog=milestone2;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="viewMyCart" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter Name="customer" SessionField="user" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</form>
